...
int birthdayCakeCandles(vector<int> candles) {
    ...
    vector<int>::iterator low = lower_bound(candles.begin(),candles.end(),candles[candles.size()-1]);
    vector<int>::iterator up = upper_bound(candles.begin(),candles.end(),candles[candles.size()-1]);
    
    num = (up - candles.begin()) - (low - candles.begin());
